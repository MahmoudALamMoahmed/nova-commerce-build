  ...
  return (
   <section className="pt-24 pb-12 md:py-32 hero-gradient">
    <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
      <div className="md:w-1/2 mb-10 md:mb-0 text-center md:text-start rtl:md:text-end">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight leading-relaxed tracking-wide mb-6">
          {t('hero.title')}
        </h1>
      ...
      <div className="md:w-1/2 md:pl-12 rtl:md:pl-0 rtl:md:pr-12">
        <div className="relative">
          ...
          />
          <div className="absolute -bottom-6 -left-6 rtl:left-auto rtl:-right-6 bg-white p-4 rounded-lg shadow-lg">
